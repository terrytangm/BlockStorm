namespace BlockStorm.BinanceConnector.Spot.WebSocketApiUtil
{
    using System;
    ...
    using BlockStorm.BinanceConnector.Spot.Models;
    ...
    public class WebSocketApiAccountTrade
    {
        ...
        public async Task AccountInfoAsync(long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            ...
            await wsApi.SendSignedAsync("account.status", parameters, requestId, cancellationToken);
        }
        ...
        public async Task AccountOrderRateLimitsAsync(long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                { "recvWindow", recvWindow },
            ...
            await wsApi.SendSignedAsync("account.rateLimits.orders", parameters, requestId, cancellationToken);
        }
        ...
        public async Task AllOrdersAsync(string symbol, long? orderId = null, long? startTime = null, long? endTime = null, int? limit = null, long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                { "symbol", symbol },
            ...
            await wsApi.SendSignedAsync("allOrders", parameters, requestId, cancellationToken);
        }
        ...
        public async Task AllOcoOrdersAsync(long? fromId = null, long? startTime = null, long? endTime = null, int? limit = null, long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                { "fromId", fromId },
            ...
            await wsApi.SendSignedAsync("allOrderLists", parameters, requestId, cancellationToken);
        }
        ...
        public async Task AccountTradeListAsync(string symbol, long? orderId = null, long? fromId = null, long? startTime = null, long? endTime = null, int? limit = null, long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                { "symbol", symbol },
            ...
            await wsApi.SendSignedAsync("myTrades", parameters, requestId, cancellationToken);
        }
        ...
        public async Task AccountPreventedMatchesAsync(string symbol, long? preventedMatchId = null, long? orderId = null, long? fromPreventedMatchId = null, int? limit = null, long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                { "symbol", symbol },
            ...
            await wsApi.SendSignedAsync("myPreventedMatches", parameters, requestId, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>OK.</returns>
        public async Task TestNewOrderAsync(string symbol, Side side, OrderType type, TimeInForce? timeInForce = null, decimal? price = null, decimal? quantity = null, decimal? quoteOrderQty = null, string newClientOrderId = null, NewOrderResponseType? newOrderRespType = null, decimal? stopPrice = null, int? trailingDelta = null, decimal? icebergQty = null, int? strategyId = null, int? strategyType = null, SelfTradePreventionMode? selfTradePreventionMode = null, long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                { "symbol", symbol },
            ...
            await wsApi.SendSignedAsync("order.test", parameters, requestId, cancellationToken);
        }
        ...
        public async Task NewOrderAsync(string symbol, Side side, OrderType type, TimeInForce? timeInForce = null, decimal? price = null, decimal? quantity = null, decimal? quoteOrderQty = null, string newClientOrderId = null, NewOrderResponseType? newOrderRespType = null, decimal? stopPrice = null, int? trailingDelta = null, decimal? icebergQty = null, int? strategyId = null, int? strategyType = null, SelfTradePreventionMode? selfTradePreventionMode = null, long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                { "symbol", symbol },
            ...
            await wsApi.SendSignedAsync("order.place", parameters, requestId, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>Order result.</returns>
        public async Task QueryOrderAsync(string symbol, long? orderId = null, string origClientOrderId = null, long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            ...
            await wsApi.SendSignedAsync("order.status", parameters, requestId, cancellationToken);
        }
        ...
        public async Task CancelOrderAsync(string symbol, long? orderId = null, string origClientOrderId = null, string newClientOrderId = null, string cancelRestrictions = null, long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            if (orderId == null && origClientOrderId == null)
            {
                throw new ArgumentException("Either orderId or origClientOrderId must be sent.");
            ...
            await wsApi.SendSignedAsync("order.cancel", parameters, requestId, cancellationToken);
        }
        ...
        public async Task CancelAndReplaceOrderAsync(string symbol, Side side, OrderType type, string cancelReplaceMode, TimeInForce? timeInForce = null, decimal? quantity = null, decimal? quoteOrderQty = null, decimal? price = null, string cancelNewClientOrderId = null, string cancelOrigClientOrderId = null, long? cancelOrderId = null, string newClientOrderId = null, int? strategyId = null, int? strategyType = null, decimal? stopPrice = null, decimal? trailingDelta = null, decimal? icebergQty = null, NewOrderResponseType? newOrderRespType = null, long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            ...
            await wsApi.SendSignedAsync("order.cancelReplace", parameters, requestId, cancellationToken);
        }
        ...
        public async Task CurrentOpenOrdersAsync(string symbol, long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                { "symbol", symbol },
            ...
            await wsApi.SendSignedAsync("openOrders.status", parameters, requestId, cancellationToken);
        }
        ...
        public async Task CancelAllOpenOrdersOnASymbolAsync(string symbol, long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                { "symbol", symbol },
            ...
            await wsApi.SendSignedAsync("openOrders.cancelAll", parameters, requestId, cancellationToken);
        }
        ...
        public async Task NewOcoOrderAsync(string symbol, Side side, decimal quantity, decimal price, decimal? stopPrice = null, string listClientOrderId = null, string limitClientOrderId = null, int? limitStrategyId = null, int? limitStrategyType = null, decimal? limitIcebergQty = null, decimal? trailingDelta = null, string stopClientOrderId = null, int? stopStrategyId = null, int? stopStrategyType = null, decimal? stopLimitPrice = null, decimal? stopIcebergQty = null, TimeInForce? stopLimitTimeInForce = null, NewOrderResponseType? newOrderRespType = null, SelfTradePreventionMode? selfTradePreventionMode = null, long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            ...
            await wsApi.SendSignedAsync("orderList.place", parameters, requestId, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>Oco Order result.</returns>
        public async Task QueryOcoOrderAsync(string origClientOrderId = null, long? orderListId = null, long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            ...
            await wsApi.SendSignedAsync("orderList.status", parameters, requestId, cancellationToken);
        }
        ...
        public async Task CancelOcoOrderAsync(string symbol, long? orderListId = null, string listClientOrderId = null, string newClientOrderId = null, long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            ...
            await wsApi.SendSignedAsync("orderList.cancel", parameters, requestId, cancellationToken);
        }
        ...
        public async Task CurrentOpenOcoOrdersAsync(long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                { "recvWindow", recvWindow },
            ...
            await wsApi.SendSignedAsync("openOrderLists.status", parameters, requestId, cancellationToken);
        }
    }
}