namespace BlockStorm.BinanceConnector.Spot.WebSocketApiUtil
{
    ...
    public class WebSocketApiGeneral
    {
        ...
        /// <returns>OK.</returns>
        public async Task PingAsync(object requestId = null, CancellationToken cancellationToken = default)
        {
            await wsApi.SendAsync("ping", null, requestId, cancellationToken);
        }
        ...
        public async Task TimeAsync(object requestId = null, CancellationToken cancellationToken = default)
        {
            await wsApi.SendAsync("time", null, requestId, cancellationToken);
        }
        ...
        public async Task ExchangeInfoAsync(string symbol = null, string[] symbols = null, string[] permissions = null, long? recvWindow = null, object requestId = null, CancellationToken cancellationToken = default)
        {
            ...
            await wsApi.SendAsync("exchangeInfo", parameters, requestId, cancellationToken);
        }
    }
}