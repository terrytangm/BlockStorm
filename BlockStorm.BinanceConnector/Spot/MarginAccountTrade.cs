namespace BlockStorm.BinanceConnector.Spot
{
    ...
    public class MarginAccountTrade : SpotService
    {
        ...
        public MarginAccountTrade(HttpClient httpClient, IBinanceSignatureService signatureService, string baseUrl = DEFAULT_SPOT_BASE_URL, string apiKey = null)
        ...
        {
            var result = await SendSignedAsync<string>(
